...
h1 {
	...
	text-transform: <?php $h1_transform = us_get_option( 'h1_transform' ); echo (isset($h1_transform[0])?$h1_transform[0]:''); ?>;
	}
h2 {
	font-size: <?php echo us_get_option( 'h2_fontsize' ) ?>px;
	letter-spacing: <?php echo us_get_option( 'h2_letterspacing' ) ?>px;
	text-transform: <?php $h2_transform = us_get_option( 'h2_transform' ); echo (isset($h2_transform[0])?$h2_transform[0]:''); ?>;
	}
h3 {
	font-size: <?php echo us_get_option( 'h3_fontsize' ) ?>px;
	letter-spacing: <?php echo us_get_option( 'h3_letterspacing' ) ?>px;
	text-transform: <?php $h3_transform = us_get_option( 'h3_transform' ); echo (isset($h3_transform[0])?$h3_transform[0]:''); ?>;
	}
h4,
.widgettitle,
.comment-reply-title,
...
.woocommerce .cross-sells > h2 {
	...
	text-transform: <?php $h4_transform = us_get_option( 'h4_transform' ); echo (isset($h4_transform[0])?$h4_transform[0]:''); ?>;
	}
h5,
.w-blog:not(.cols_1) .w-blog-list .w-blog-post-title {
	...
	text-transform: <?php $h5_transform = us_get_option( 'h5_transform' ); echo (isset($h5_transform[0])?$h5_transform[0]:''); ?>;
	}
h6 {
	font-size: <?php echo us_get_option( 'h6_fontsize' ) ?>px;
	letter-spacing: <?php echo us_get_option( 'h6_letterspacing' ) ?>px;
	text-transform: <?php $h6_transform = us_get_option( 'h6_transform' ); echo (isset($h6_transform[0])?$h6_transform[0]:''); ?>;
	}
