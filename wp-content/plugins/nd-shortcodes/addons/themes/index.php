  ...
  ?>
    ...
    <div class="wrap">
      ...
      <h1 class="nd_options_margin_bottom_15_important">
        ...
        <span class="nd_options_margin_left_10 title-count theme-count">6</span>
      </h1>
      ...
      <div class="theme-browser rendered">
        <div class="themes wp-clearfix">
          ...
          <div class="theme nd_options_cursor_auto_important nd_options_margin_bottom_30_important" tabindex="0">
              ...
              <span class="more-details"><a target="_blank" class="nd_options_color_ffffff nd_options_color_ffffff_hover nd_options_text_decoration_initial" href="#"><?php _e('Theme Details','nd-shortcodes'); ?></a></span>

              <h2 class="theme-name"><a target="_blank" class="nd_options_color_23282d nd_options_text_decoration_initial nd_options_color_23282d_hover" href="#">Education Pack</a></h2>
            
              <div class="theme-actions">
                <a target="_blank" class="button button-secondary activate" href="#"><?php _e('Demo','nd-shortcodes'); ?></a>
                <a target="_blank" class="button button-primary load-customize hide-if-no-customize" href="#"><?php _e('Purchase','nd-shortcodes'); ?></a>
              </div>
          ...
          <div class="theme nd_options_cursor_auto_important nd_options_margin_bottom_30_important" tabindex="0">
              ...
              <div class="theme-actions">
                <a target="_blank" class="button button-secondary activate" href="http://www.nicdarkthemes.com/themes/wedding-industry/wp/intro/"><?php _e('Demo','nd-shortcodes'); ?></a>
