...
if ( $nd_options_customizer_footer_2_right_content == '' ) { $nd_options_customizer_footer_2_right_content = 'Wonderful Education WP Theme';  }
...
<!--START copyright-->
<div style="background-color: <?php echo $nd_options_customizer_footer_2_bg; ?>" class="nd_options_section">
