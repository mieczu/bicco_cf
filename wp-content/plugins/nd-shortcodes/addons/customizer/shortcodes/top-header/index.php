...
function nd_options_icon_text( $nd_options_atts ) {
    ...
    if ( $nd_options_icon_text['text'] == '' ) {
        ...
        $nd_options_icon_text_text = '
            ...
            <div class="nd_options_display_table_cell nd_options_vertical_align_middle    ">
                <a style="color:'.$nd_options_icon_text_color.';" class="'.$nd_options_text_margin.'" href="'.$nd_options_icon_text['link'].'">'.$nd_options_icon_text['text'].'</a>
            </div>
    ...
    if ( $nd_options_icon_text['icon'] != '' ) {
   	...
   	$nd_options_str .= '
        ...
        <div class=" '.$nd_options_icon_text['class'].' nd_options_display_table nd_options_float_'.$nd_options_icon_text_float.'">
            '.$nd_options_icon_text_icon.'
            '.$nd_options_icon_text_text.'    
        </div>
