...
{  
  ...
  $str .= ' <'.$nd_options_text_tag.' style="color:'.$nd_options_text_color.'; text-align:'.$nd_options_text_align.'; font-size:'.$nd_options_text_font_size.'px; line-height:'.$nd_options_text_line_height.'px; font-weight:'.$nd_options_text_weight.';" class="'.$nd_options_class.' '.$nd_options_text_family.' ">'.$nd_options_text.'</'.$nd_options_text_tag.'> ';
   ...
   vc_map( array(
      ...
      "params" => array(
         ...
         'type' => 'dropdown',
          ...
          'value' => array('Select Weight','normal','bold'),
