...
{  
  ...
  //output values
  if ($nd_options_title == '') { $nd_options_title_output = ''; }else{ $nd_options_title_output = '<h3 class="'.$nd_options_title_font.'" style="margin:'.$nd_options_title_margin.'; color:'.$nd_options_title_text_color.'; font-size:'.$nd_options_title_size.'px;line-height:'.$nd_options_title_size.'px;">'.$nd_options_title.'</h3>'; }
  if ($nd_options_description == '') { $nd_options_description_output = ''; }else{ $nd_options_description_output = '<p class="'.$nd_options_description_font.'" style="margin:'.$nd_options_description_margin.'; color:'.$nd_options_description_text_color.'; font-size:'.$nd_options_description_size.'px;line-height:'.$nd_options_description_size.'px;">'.$nd_options_description.'</p>'; }
      ...
      "params" => array(
        ...
        //link options
         ...
         'type' => 'dropdown',
          ...
          'value' => array('select'=>'','0px'=>'0px','1px'=>'1px','2px'=>'2px','3px'=>'3px','4px'=>'4px','5px'=>'5px','6px'=>'6px','7px'=>'7px','8px'=>'8px','9px'=>'9px','10px'=>'10px'),
          'description' => __( "Select border width", "nd-shortcodes" ),
          'dependency' => array( 'element' => 'nd_options_link_adv_options', 'value' => array( 'yes' ) )
         ),
         array(
